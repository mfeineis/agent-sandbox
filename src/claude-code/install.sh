...
GITCONFIG
  ...
  [ -f "/commandhistory/.bash_history" ] || touch /commandhistory/.bash_history
  chown -R "$_REMOTE_USER" /commandhistory

  cat << 'ENV' >> "/home/$_REMOTE_USER/.bashrc"
export HISTFILE=/commandhistory/.bash_history
export CLAUDE_CONFIG_DIR=/home/$_REMOTE_USER/.claude
